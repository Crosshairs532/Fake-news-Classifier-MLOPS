...
class ModelTrainer:
    ...
    def model_object(self, train_arr, test_arr):
        try:
            x_train, x_test, y_train, y_test = train_test_split(
                train_arr[:, :-1], train_arr[:, -1], test_size=0.2, random_state=42
            )
    ...
    def initiate_model_trainer(self, train_arr, test_arr):
        ...
        with mlflow.start_run() as run:
            ...
            # Save model locally for evaluation stage to load
            model_data = {
            ...
            # Log params and metrics only — no log_model, no save_model_info
            ...
            logger.info('Model Saved locally. Evaluation stage will log to MLflow.')
